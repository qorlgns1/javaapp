...
public class DongaCrawling {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// 총 뉴스 건수가 몇건 들어있는지 선택자를 이용해서 가져오기
		...
		try {
			for (int i = 0; i < pageCnt; i++) {
				...
				try {
					...
					//선생님이 #content > div.searchContWrap > div.searchCont > div:nth-child(2) > div.t > p.tit > a
					//위에 문장중 div.t > p.tit > a 이것만 사용해도된다고하셨는데
					//테스트결과 content 부터 들어간 문장을 다사용하면
					//한정적으로 크롤링이 되고
					// div.t > p.tit > a 여기부분만 사용해야 전체부분 크롤링이 가능했었다.
